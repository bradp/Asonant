				...
				<header class="entry-header">
					...
					<div class="entry-meta">
						<?php
							...
							printf( __( 'Published <span class="entry-date"><time class="entry-date" datetime="%1$s">%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%8$s</a>', 'asonant' ),
					...
					<nav role="navigation" id="image-navigation" class="navigation-image">
						<div class="nav-previous"><?php previous_image_link( false, __( '<span class="meta-nav">&larr;</span> Previous', 'asonant' ) ); ?></div>
						<div class="nav-next"><?php next_image_link( false, __( 'Next <span class="meta-nav">&rarr;</span>', 'asonant' ) ); ?></div>
				...
				<div class="entry-content">
					<div class="entry-attachment">
						<div class="attachment">
							...
							<?php do_action('asonant_before_attached_image'); ?>
							<?php _asonant_the_attached_image(); ?>
							<?php do_action('asonant_after_attached_image'); ?>
					...
					<?php
						the_content();
						wp_link_pages( array( 
							'before' => '<div class="page-links">' . __( 'Pages:', 'asonant' ), 
							'after' => '</div>',
						) ); 
					?>
